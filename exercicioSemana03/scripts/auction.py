...
def main():
    ...
    #A taxa é alterada para 80 pelo dono do contrato
    auction.changeFee(80, {'from':contractOwner})
    try:
    #O dono do token tenta altera a taxa para 50, mas não consegue e é lançada uma exception
        auction.changeFee(50, {'from':tokenOwner})
    except:
        print("Dont!!")
    ...
    #Utilizando a função auxiliar para demonstrar o valor da taxa ao final com os demais resultados
    print(auction.verifyFee())
